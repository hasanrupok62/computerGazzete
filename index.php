                    ...
                    <div class="row slide-margin">
                        <div class="col-sm-6">
                            <div class="carousel-content">
                                <h1 class="animation animated-item-1"><?php echo $row['Subject']; ?></h1>
                                <h2 class="animation animated-item-1"><?php echo $row['Body']; ?></h2>

                                <a class="btn-slide animation animated-item-3" href="Reviews.php?id=<?php echo $row['Body'] ?>">Read More</a>
                        ...
                        <div class="col-sm-6 hidden-xs animation animated-item-4">
                            <div class="slider-img">
                                <img src="images/<?php echo $row['Image']; ?>" class="img-responsive" alt="" width="500" height="550">
                            </div>
                        </div>
    ...
    <section id="recent-works">
        <div class="container">
            <div class="center wow fadeInDown">
                <h1 style="color: red;">Recent Introduced</h1>
                <p class="lead">Recent Introduced Product which will be launched soon <br> Here are some trailer picture of that Products</p>
            </div>
<hr>
            <div class="row">
                    ...
                    <div class="recent-work-wrap">
                        ...
                        <div class="overlay">
                            <div class="recent-work-inner">
                                <h3><a href="#">Discover Purpose</a> </h3>
