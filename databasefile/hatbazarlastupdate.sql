...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 19, 2017 at 11:10 PM
...
(1, 'Praesent dapibusneque id cursus faucioibus tortor neque tiegetas augue', 'Phasellus ultrices nulla quis nibh. Quisque a lectus. Donec consectetuer ligula vulputate.', 'images/img1.jpg', 'mahmud@gmail.com', '2017-08-16 00:22:59', 1),
(2, 'Integer vitae libero ac risus egestas', 'Sed adipiscing ornare risus. Morbi est est, blandit sit amet, sagittis vel, euismod vel ipsum dolor.', 'images/img3.jpg', 'mahmud@gmail.com', '2017-08-16 00:22:59', 1),
...
(4, 'CURSUS FAUCIO', 'Phasellus ultrices nulla.', 'images/img2.jpg', 'mahmud@gmail.com', '2017-08-16 00:22:59', 1),
(5, 'Aliquam tincidunt mauris eu risus', 'Morbi in sem quis dui placerat ornare. Pellentesque odio nisi, euismod in, pharetra a, ultricies in, diam. Sed arcu. Cras consequat.', '', 'mahmud@gmail.com', '2017-08-16 00:22:59', 1),
(6, 'Praesent dapibusneque id cursus faucioibus tortor neque tiegetas augue', 'Phasellus ultrices nulla quis nibh. Quisque a lectus. Donec consectetuer ligula vulputate.', 'images/img10.jpg', 'mahmud@gmail.com', '2017-08-16 00:22:59', 1),
...
(8, 'Integer vitae libero risus egestas', 'Morbi interdum mollis sapien. Sed ac risus. Phasellus lacinia, magna a ullamcorper laoreet, lectus arcu pulvinar risus, vitae facilis', 'images/2222.jpg', 'mahmud@gmail.com', '2017-08-16 00:22:59', 1),
(9, 'Praesent dapibusneque id cursus faucioibus tortor neque tiegetas augue', 'Phasellus ultrices nulla quis nibh. Quisque a lectus. Donec consectetuer ligula vulputate.', 'images/img13.jpg', 'mahmud@gmail.com', '2017-08-16 00:22:59', 1),
...
--
-- Constraints for table `comment on news`
--
ALTER TABLE `comment on news`
  ADD CONSTRAINT `comment on news_ibfk_1` FOREIGN KEY (`Email`) REFERENCES `customer` (`email`),
  ADD CONSTRAINT `comment on news_ibfk_2` FOREIGN KEY (`NewsID`) REFERENCES `news` (`NewsID`);
