...
if(isset($_POST['update']))
{
    ...
    $sql="UPDATE products_list SET product_name='$product_name',product_desc='$product_desc',product_image='$product_image',product_price='$product_price', RAM='$RAM', graficCard='$graficCard', batterylifetime='$batterylifetime', size='$size',  brand='$brand' WHERE product_code='$product_code'";
    mysqli_query($db,$sql);  
    $_SESSION['message']="";
