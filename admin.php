...
if(isset($_POST['Insert']))
{
    ...
    $sql="INSERT INTO products_list(product_name,cat_id,product_desc,product_code,product_image,product_price) VALUES('$product_name','$cat_id','$product_desc','$product_code','$product_image','$product_price')";
    mysqli_query($db,$sql);  
    $_SESSION['message']=""; 
